...
```bash
python3 specification/v0_9_1/test/run_tests.py
```

The script will:

1. Load all schemas from `specification/v0_9_1/json`.
2. Execute all test suites defined in `specification/v0_9_1/test/cases/*.json`.
